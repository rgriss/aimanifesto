...
class ApiToolController extends Controller
{
    ...
    public function store(Request $request): JsonResponse
    {
        try {
            ...
            $tool = Tool::create([
                ...
                'popularity_tier' => $validated['popularity_tier'] ?? null,
                'momentum_score' => $validated['momentum_score'] ?? null,
    ...
    private function validateToolRequest(Request $request, bool $isCreating = true): array
    {
        ...
        return $request->validate([
            ...
            'hn_search_query' => ['nullable', 'string', 'max:255'],
            'category' => [$required, 'string', 'max:255'],
            'pricing_model' => ['nullable', 'string', 'in:free,freemium,paid,enterprise'],
            'price_description' => ['nullable', 'string'],
            'company_name' => ['nullable', 'string', 'max:255'],
            'popularity_tier' => ['nullable', 'string', 'in:mainstream,well_known,growing,niche,emerging'],
            'momentum_score' => ['nullable', 'integer', 'min:1', 'max:5'],
    ...
    private function formatToolResponse(Tool $tool, bool $detailed = false): array
    {
        ...
        if ($detailed) {
            $data = array_merge($data, [
                ...
                'popularity_tier' => $tool->popularity_tier,
                'momentum_score' => $tool->momentum_score,
